    ...
    if (($amount)<0)
   {
    ...
    //For 0 (zero) value
         ...
         echo "</script>";
                ...
                $sender = $sql1['name'];
                $receiver = $sql2['name'];
                $sql = "INSERT INTO transaction(`sender`, `receiver`, `balance`,date_time) VALUES ('$sender','$receiver','$amount',now())";
                $query=mysqli_query($conn,$sql);
...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxfAOOnxrkfXJ8MTtcEl6JReYY7tILazdVhSCGPCnafRzlZFKIPSuK97lUWvQksgG9SH4&usqp=CAU" alt="Bank" width="80" height="60"> <div class="logo"strong> Sparks Bank  </strong></div> </a>
    ...
    <class class="welcome">
        <h2>
            <img src="https://thumbs.gfycat.com/DistortedLimitedAlbatross-max-1mb.gif" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> 
        </h2>
    </class>
 ...
 <div class="container">
        ...
        <div>
            <table class="table table-bo rdered table-hover">
